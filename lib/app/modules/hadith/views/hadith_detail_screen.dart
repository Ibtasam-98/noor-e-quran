...
import '../controllers/hadith_detail_screen_controller.dart';
...
class HadithDetailScreen extends StatelessWidget {
  ...
  final HadithDetailScreenController hadithDetailScreenController = Get.put(HadithDetailScreenController());
  ...
  Widget build(BuildContext context) {
    hadithDetailScreenController.checkBookmarkStatus(hadithNumber);
              ...
              children: [
                if (!isFromSavedHadithList)
                  Obx(() {
                    return IconButton(
                      icon: Icon(
                        hadithDetailScreenController.isBookmarked.value
                            ? Icons.bookmark
                            : Icons.bookmark_border,
                        color: iconColor,
                      ),
                      onPressed: () {
                        hadithDetailScreenController.toggleBookmark(hadithNumber, {
                  ...
                  child: Container(
                    ...
                    child: Html(
                      ...
                      style: {
                        "body": Style(
                          color: textColor,
                          fontSize: FontSize(hadithDetailScreenController.currentFontSize.value),
                          textAlign: TextAlign.right,
                          margin: Margins(left: Margin.zero()),
                        ),
                      },
              ...
              Obx(() {
                return Padding(
                  ...
                  child: Html(
                    ...
                    style: {
                      "body": Style(
                        fontSize: FontSize(hadithDetailScreenController.currentFontSize.value.sp),
                        color: textColor,
                        textAlign: TextAlign.left,
                        fontWeight: FontWeight.normal,
                        fontFamily: 'quicksand',
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Obx(
                    () => Slider(
                  value: hadithDetailScreenController.currentFontSize.value,
                  min: 12.0,
                  max: 60.0,
                  divisions: 14,
                  label: "${hadithDetailScreenController.currentFontSize.value.toStringAsFixed(1)}",
                  activeColor: AppColors.primary,
                  inactiveColor: AppColors.primary,
                  onChanged: (value) {
                    hadithDetailScreenController.updateFontSize(value);
                  },
                ),
              ),
            ),
