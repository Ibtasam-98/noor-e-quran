        ...
        body: Padding(
          ...
          child: Obx(() => ListView(
            children: [
              ...
              // Translation spacing and font size
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  AppSizedBox.space10h,
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(12.w),
                      child: Slider(
                        value: controller.translationFontSize.value.clamp(20.0, 100.0), // Ensure value is clamped
                        min: 20.0,
                        max: 100.0,
                        activeColor: AppColors.primary,
                        divisions: 80,
              ...
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.all(12.w),
                  child: Slider(
                    value: controller.arabicFontSize.value.clamp(20.0, 100.0), // Ensure value is clamped
                    min: 20.0,
                    max: 100.0,
                    activeColor: AppColors.primary,
                    divisions: 80,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...translationFonts.map((String font) {
                      return Column(
                        children: [
                          RadioListTile<String>(
                            title: CustomText(
