...
class AppDataDeleteScreen extends StatelessWidget {
  const AppDataDeleteScreen({super.key});
      ...
      body: Column(
        ...
        children: [
          ...
          Column(
            children: [
              CustomText(
                title: 'Continuing will permanently delete all data stored locally on this device. This includes bookmarks for '
                    'hadith and surahs, Quran memorization progress and all saved content.',
                fontSize: 16.sp,
                ...
                onTap: () {
                  ...
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: CustomText(
                        title: 'Are you sure you want to delete all locally stored data?',
                        fontSize: 16.sp,
                            ...
                            CustomButton(
                              ...
                              onTap: () async {
                                ...
                                CustomSnackbar.show(
                                  ...
                                  icon: const Icon(Icons.check), // Added const
