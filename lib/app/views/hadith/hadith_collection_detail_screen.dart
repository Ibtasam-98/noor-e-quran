...
import '../../controllers/hadith_collection_detail_controller.dart';
...
class HadithCollectionDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(HadithCollectionDetailController(collection));
        ...
        children: [
          Obx(() => LinearProgressIndicator(
            ...
            valueColor: AlwaysStoppedAnimation<Color>(
              controller.isScrolling.value ? AppColors.primary : AppColors.grey,
            ),
            minHeight: 3.h,
          )),
                ...
                children: [
                  ...
                  Obx(() => controller.isSearchVisible.value
                    ...
                    onChanged: controller.filterBooks,
                      ...
                      : SizedBox.shrink()),
                  Expanded(
                    child: Obx(() => controller.filteredBooks.isEmpty
                        ? Center(
                      child: CustomText(
                        title: "No book found",
                        fontSize: 18.sp,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: ListTile(
                            ...
                            //
                            // subtitle: CustomText(
                            //   title: 'Total Hadiths ${book.numberOfHadith}',
                            //   fontSize: 14.sp,
