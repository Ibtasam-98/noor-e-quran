                          ...
                          Container(
                            ...
                            child: Center(
                              child: ListView.builder(
                                shrinkWrap: true,
                                scrollDirection: Axis.horizontal,
                                itemCount: homeScreenController.isNamazLoading
                                    .value ? 5 : homeScreenController.namazTimes
                                    .length,
                                itemBuilder: (context, index) {
                                  final namazName = homeScreenController
                                      .namazTimes[index];
                                  final namazTime = homeScreenController
                                      .namazTimings[namazName] ?? "--/--";
                                  final formattedTime = homeScreenController
                                      .formatTime(namazTime,
                                      homeScreenController.is24HourFormat);
                                  final iconName = homeScreenController
                                      .icons[index];
                                  final isNextNamaz = namazName ==
                                      homeScreenController.nextNamazName.value;
                                  final isLoading = homeScreenController
                                      .isNamazLoading.value;
